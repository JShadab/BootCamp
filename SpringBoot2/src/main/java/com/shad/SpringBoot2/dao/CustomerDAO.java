package com.shad.SpringBoot2.dao;
...
public class CustomerDAO {
	...
	public Customer findById(long customerID) {
		...
		Customer emp = jdbcTemplate.queryForObject(selectSQL, new Object[] { customerID },
	...
	public Customer getCustomerByEmailAndPassword(String email, String password) {
		...
		Customer emp = jdbcTemplate.queryForObject(selectSQL, new Object[] { email, password },
				new BeanPropertyRowMapper<>(Customer.class));
